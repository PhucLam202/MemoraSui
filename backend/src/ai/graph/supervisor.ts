      ...
      [
        {
          ...
          content: [
            ...
            'Use research when the question is about another project, tokenomics, news, sentiment, competitor comparison, recent protocol context, or a token/project overview.',
            'Return JSON only with this shape:',
            '{"plan":"short plan","agents":["portfolio","gas"],"primaryIntent":"wallet_summary|portfolio|fee|activity|object|protocol_usage|research|staking|unknown"}',
