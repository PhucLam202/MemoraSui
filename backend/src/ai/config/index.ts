...
const DEFAULT_CONFIG: LangGraphAgentsConfig = {
  ...
  supervisor: {
    ...
    systemPrompt: [
      ...
      'Use portfolio for balances, holdings, allocation, PnL, and wallet summary.',
